							...
							<table
								...
								<tr height='250px'>
									<td style='padding: 40px 0 20px 0;'>
										...
										<p>
											Total Donations: <strong>
												<% out.print(formatter.format(session.getAttribute("total"))); %>
											</strong>
										</p> <br />
										<p>
								...
								<tr>
									<td class='active'><a href='#'><h3>DONATION LOG</h3></a></td>
								</tr>
								<tr>
									<td><a href='users_wp.jsp'><h3>USERS</h3></a></td>
								</tr>
								<tr>
